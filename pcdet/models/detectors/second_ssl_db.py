...
class SECOND_SSL_db(Detector3DTemplate):
    ...
    def update_thresh(self):
        ...
        k = int(m/800)
        print(m)
        thresh = torch.tensor(thresh - k/10) 
        thresh = torch.clamp(thresh, min=0.4)
        self.thresh[0] = thresh
        self.thresh[1] = thresh
        self.thresh[2] = thresh 
        print(self.thresh)
