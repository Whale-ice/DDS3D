...
class VoxelRCNN_SSL(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        if self.training or self.vis_ema:
            ...
            with torch.no_grad():
                ...
                #print(batch_dict_ema['gt_boxes'].shape)
                ...
                #print(ori_unlabeled_boxes.shape)
                ...
                for i, ind in enumerate(unlabeled_mask):
                    ...
                    cls_pseudo = cls_pseudo[unzero_inds]#选出所有有label的pseudo labels
            ...
            #print(loss_rpn_cls,loss_rpn_box)
