...
class PVRCNNHead_dl(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, num_class=1,
        ...
        self.use_dense_label = self.model_cfg.get('USE_DENSE_LABEL', False)
    ...
    def forward(self, batch_dict, disable_gt_roi_when_pseudo_labeling=False):
        ...
        # RoI aware pooling
        pooled_points, pooled_features = self.roi_grid_pool(batch_dict)  # (BxN, 6x6x6, C)
    ...
    def dense_point_loss(self, tb_dict=None):
        return
